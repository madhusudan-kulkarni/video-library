...
export const playlists = [
  {
    id: uuid(),
    name: 'Favorites',
    videos: [videos[0]._id, videos[1]._id],
  },
  {
    id: uuid(),
    name: 'Tutorials',
    videos: [videos[2]._id, videos[3]._id, videos[4]._id],
  },
  {
    id: uuid(),
    name: 'Animations',
    videos: [videos[5]._id, videos[6]._id, videos[7]._id],
  },
]

export const watchLater = [videos[8]._id, videos[9]._id]
